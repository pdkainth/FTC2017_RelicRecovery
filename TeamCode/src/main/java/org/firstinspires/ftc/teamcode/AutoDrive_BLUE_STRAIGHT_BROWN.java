...
@Autonomous(name = "Auto Drive : BLUE STRAIGHT mode BROWN glyph")
public class AutoDrive_BLUE_STRAIGHT_BROWN extends OpMode {
  ...
  public void init() {
    ...
    autoDrive.init(hardwareMap, telemetry, MyAutoDrive.FieldMode.STRAIGHT,
      MyAutoDrive.AllianceColor.BLUE, MyAutoDrive.GlyphColor.BROWN);
