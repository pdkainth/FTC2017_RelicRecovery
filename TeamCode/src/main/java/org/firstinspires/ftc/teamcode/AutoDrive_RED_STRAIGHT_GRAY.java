...
@Autonomous(name = "Auto Drive : RED STRAIGHT mode GRAY glyph")
public class AutoDrive_RED_STRAIGHT_GRAY extends OpMode {
  ...
  public void init() {
    ...
    autoDrive.init(hardwareMap, telemetry, MyAutoDrive.FieldMode.STRAIGHT,
      MyAutoDrive.AllianceColor.RED, MyAutoDrive.GlyphColor.GRAY);
